    ...
    public function run(): void
    {
        $phims = [
            ...
            [
                ...
                'thoi_luong'    => '118',
                'noi_dung'      => 'Vào đêm Giáng sinh, một nhóm sinh viên đại học đã bị tấn công bởi những sinh vật bí ẩn. Để bảo vệ bạn bè và người thân, họ phải chiến đấu chống lại những thế lực siêu nhiên này. Trong cuộc chiến sinh tồn đầy cam go, họ phát hiện ra một âm mưu đen tối liên quan đến nguồn gốc của những sinh vật này và vai trò của chúng trong thế giới hiện đại.',
                'tinh_trang'    => 1,
            ],
        ];
